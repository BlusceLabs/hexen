...
from hexenapi.backend._bases_v1 import (
...
from hexenapi.backend.helpers import assert_instance, get_absolute_url
from hexenapi.backend.models_v1 import (
    CaptionFileMetadata,
        ...
        **kwargs,
        ...
        Kwargs: Nothing much folk.
                ...
                will accept similar parameters in
                    `hexenapi.extra.movies.Auto.run` method.
        """
        assert_instance(
            search_results_item,
            SearchResultsItem,
