...
from hexenapi.v1.constants import (
    CURRENT_WORKING_DIR,
...
from hexenapi.v1.download import (
    CaptionFileDownloader,
    DownloadableMovieFilesDetail,
    MediaFileDownloader,
    resolve_media_file_to_be_downloaded,
)
from hexenapi.v1.exceptions import ZeroSearchResultsError
from hexenapi.v1.helpers import assert_membership, get_event_loop
        ...
        if year is not None:
            ...
            if target_movie is None:
                raise ZeroSearchResultsError(
                    ...
                    f"- {year}. Try a different value or omit the filter."
                )
        else:
