...
from hexenapi.backend.extractor.exceptions import DetailsExtractionError
from hexenapi.backend.extractor.helpers import souper
from hexenapi.backend.extractor.models.json import (
...
from hexenapi.backend.extractor.models.tag import (
    BasicsModel,
    CastModel,
    HeadersModel,
    ItemTagDetailsModel,
...
class JsonDetailsExtractor:
    ...
    @classmethod
    def extract(cls, content: str, whole: bool = False) -> dict[str, t.Any]:
