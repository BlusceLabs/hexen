...
NOTE: This module re-exports from v1/download.py for backwards compat.
download_v1.py contains an independent implementation of the same classes.
Consider consolidating these into a single module in a future refactor.
"""
...
class BaseDownloadableFilesDetail(
    ...
    _subject_types: tuple[SubjectType, ...] | None = None
