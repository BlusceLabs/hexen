...
from hexenapi.backend.constants import ResolutionType, SubjectType
from hexenapi.backend.models.common import MODEL_CONFIG
from hexenapi.backend.models.homepage import Image
from hexenapi.backend.models.search import OpsModel, ResultsSubjectModel
...
class RootItemDetailsModel(ResultsSubjectModel):
    ...
    def validate_ops(value):
        return json.loads(value) if bool(value) else None
