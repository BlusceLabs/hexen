"""Exceptions module - self-contained, no v1/v3 imports"""
...
class InvalidDetailPathError(MovieboxApiException):
    """Raised when specific detail path does not match required format."""


class ResultsNavigationError(MovieboxApiException):
    """Raised when trying to navigate to an invalid page."""


class MissingDubError(MovieboxApiException):
    """Raised when a requested dub language is not found."""
